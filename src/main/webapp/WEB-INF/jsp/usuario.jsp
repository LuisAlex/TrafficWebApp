 	...
 	<div id="header"> 
 		...
 		<div class="top"> 
 			...
 			<div id="logo"> 
 				...
 				<h1 id="title"><sec:authentication property="principal.username" /></h1>
 				<h5><sec:authentication property="principal.authorities" /></h5>
 			...
 			<ul> 
 				...
 				<li><a href="logout" id="top-link" class="skel-layers-ignoreHref"><span class="icon fa-users"><spring:message code="user.logout" /></span></a></li>
			</ul> 
 			</nav> 
 		</div> 
